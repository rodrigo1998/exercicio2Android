...
package br.usjt.ads.desmob.atividades.util;
...
public class Utils {
    ...
    private static br.usjt.ads.desmob.atividades.util.StatusTracker mStatusTracker = br.usjt.ads.desmob.atividades.util.StatusTracker.getInstance();
